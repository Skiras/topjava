...
public class ExceptionInfoHandler {
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String... details) {
        ...
        return new ErrorInfo(req.getRequestURL(), errorType, details.length != 0 ?
                details : new String[]{ValidationUtil.getMessage(rootCause)});
    }
    ...
    public ErrorInfo methodArgumentNotValidException(HttpServletRequest req, Exception e) {
        var fieldErrors = e instanceof BindException ? ((BindException) e).getFieldErrors() :
